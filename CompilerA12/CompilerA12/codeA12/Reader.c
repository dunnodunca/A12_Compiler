...
ReaderPointer readerCreate(kao_intg size, kao_intg increment, kao_intg mode) {
...
ReaderPointer readerAddChar(ReaderPointer const readerPointer, kao_char ch) {
	...
	if (readerPointer->offset.wrte * (kao_intg)sizeof(kao_char) < readerPointer->size) { 
...
*************************************************************
*/
kao_boln readerSetMark(ReaderPointer const readerPointer, kao_intg mark) {
	/* TO_DO: Defensive programming */
...
*************************************************************
*/
kao_intg readerPrint(ReaderPointer const readerPointer) {
	kao_intg cont = 0;
	kao_char c;
...
*************************************************************
*/
kao_intg readerLoad(ReaderPointer const readerPointer, FILE* const fileDescriptor) {
	kao_intg size = 0;
	kao_char c;
	/* TO_DO: Defensive programming */
	if(readerPointer==NULL) return kao_FALSE;
...
*************************************************************
*/
kao_string readerGetContent(ReaderPointer const readerPointer, kao_intg pos) {
	/* TO_DO: Defensive programming */
	if(readerPointer == NULL) return kao_FALSE;
...
*************************************************************
*/
kao_intg readerGetPosRead(ReaderPointer const readerPointer) {
	/* TO_DO: Defensive programming */
	if(readerPointer == NULL) return kao_FALSE;
	/* TO_DO: Return read */
...
*************************************************************
*/
kao_intg readerGetPosWrte(ReaderPointer const readerPointer) {
	/* TO_DO: Defensive programming */
	if(readerPointer == NULL) return kao_FALSE;
	/* TO_DO: Return wrte */
...
*************************************************************
*/
kao_intg readerGetPosMark(ReaderPointer const readerPointer) {
	/* TO_DO: Defensive programming */
	if(readerPointer == NULL) return kao_FALSE;
	/* TO_DO: Return mark */
...
*************************************************************
*/
kao_intg readerGetSize(ReaderPointer const readerPointer) {
	/* TO_DO: Defensive programming */
	if(readerPointer == NULL) return kao_FALSE;
	/* TO_DO: Return size */
...
*************************************************************
*/
kao_intg readerGetInc(ReaderPointer const readerPointer) {
	/* TO_DO: Defensive programming */
	if(readerPointer == NULL) return kao_FALSE;
...
*************************************************************
*/
kao_intg readerGetMode(ReaderPointer const readerPointer) {
	/* TO_DO: Defensive programming */
	if(readerPointer == NULL) return kao_FALSE;
	/* TO_DO: Return mode */
...
*************************************************************
*/
kao_intg readerNumErrors(ReaderPointer const readerPointer) {
	/* TO_DO: Defensive programming */
	if(readerPointer == NULL) return kao_FALSE;
